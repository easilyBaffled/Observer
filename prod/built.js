...
var Campaign = React.createClass({displayName: 'Campaign',
  render: function() {
    ...
    return React.DOM.div({className: campaign_classes});
  }
});
/** @jsx React.DOM */
...
/** @jsx React.DOM */
var Menu_Buttons = React.createClass({displayName: 'Menu_Buttons',
    getInitialState: function() {
    	return {
            view_state: this.props.view_state,
    	}
    ...
    render: function() {
        ...
        var buttons = button_descriptions.map(function(button_text) {
            return React.DOM.button({className: button_text}, button_text)
        });
        return (React.DOM.div({className: "menu_buttons_container"}, 
                    buttons
        	    ));
  }
});
